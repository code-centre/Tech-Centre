...
export default function HeroSection({ onEnroll }: HeroSectionProps) {
  return (
    <section className="relative py-20 md:py-28 px-4 overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-[var(--primary)]/20 via-[var(--secondary)]/5 to-background" />
      <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-[var(--secondary)]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/3" />
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-[var(--primary)]/10 rounded-full blur-3xl translate-y-1/2 -translate-x-1/3" />

      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          <p className="inline-flex items-center gap-2 text-xs font-bold tracking-[0.2em] uppercase text-[var(--secondary)] mb-6 font-mono">
          ...
          <p className="text-base text-text-muted/80 mb-10 max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            <div className="flex items-center gap-3 px-5 py-3 rounded-xl border border-[var(--secondary)]/30 bg-[var(--secondary)]/5">
            ...
            <span className="text-text-muted/50 font-bold text-sm">o</span>
            <div className="flex items-center gap-3 px-5 py-3 rounded-xl border border-[var(--secondary)]/30 bg-[var(--secondary)]/5">
              <span className="text-xs font-bold tracking-widest uppercase text-[var(--secondary)] font-mono">
                Ruta JavaScript
              </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-14">
            ...
            <a
              href="#programa"
              className="inline-flex items-center gap-2 px-8 py-4 border border-border-color text-text-primary font-medium rounded-xl hover:border-[var(--secondary)]/50 hover:bg-[var(--secondary)]/10 transition-all duration-300"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
            {stats.map((stat) => (
              <article
                key={stat.label}
                className="flex flex-col items-center gap-2 p-5 rounded-xl bg-[var(--card-background)] border border-border-color"
              >
                <stat.icon className="w-5 h-5 text-[var(--secondary)]" />
