        ...
        <div className="flex gap-4 ml-auto">
          {user?.rol === "admin" && (
            <button
              ...
              className="flex items-center gap-2 px-3 py-1 bg-zuccini hover:bg-blue-600 text-white text-sm rounded-md transition-colors"
            >
              <PlusCircle size={14} />
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm font-medium whitespace-nowrap min-w-[100px] transition-all ${
                      selectedTicket === index
                        ? "bg-zuccini text-white shadow-lg shadow-zuccini/20"
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-center justify-between py-3 border-b border-zinc-700/50 group hover:border-zinc-600/70 transition-all">
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="bg-zinc-900 p-2 rounded-lg shadow-inner border border-zinc-800 group-hover:border-zuccini/30 transition-all">
                    <MapPinIcon size={18} className="text-zuccini" />
                  </div>
                  <span className="font-medium text-white text-base">Modalidad</span>
                </div>
                <div className="bg-zinc-900 text-white px-4 py-1.5 rounded-full text-sm font-medium border border-zinc-800/80 shadow-sm hover:border-zuccini/20 transition-colors">
                  {cohort?.modality}
                </div>
              </div>
              <div className="flex items-center justify-between py-3 border-b border-zinc-700/50 group hover:border-zinc-600/70 transition-all">
                <div className="flex items-center gap-3 text-gray-700">
                  <div className="bg-zinc-900 p-2 rounded-lg shadow-inner border border-zinc-800 group-hover:border-zuccini/30 transition-all">
                    <ClockIcon size={18} className="text-zuccini" />
                  </div>
                    ...
                    {/* {currentTicket.benefits && currentTicket.benefits.length > 0 ? (
                      currentTicket.benefits.map((benefit, i) => (
                        <li key={i} className="flex items-start gap-2 text-gray-300 text-sm">
                          <span className="text-zuccini mt-0.5">✓</span>
                          <span>{benefit}</span>
                        </li>
                      ))
                    ) : (
              ...
              <div className="mt-5 bg-zinc-900/90 p-5 rounded-xl shadow-lg border border-zinc-800/40 relative overflow-hidden group">
                {/* Línea decorativa */}
                <div className="absolute left-0 top-0 bottom-0 w-1.5 bg-zuccini"></div>

                {/* Efecto decorativo */}
                <div className="absolute -right-10 -top-10 w-24 h-24 rounded-full bg-zuccini/5 blur-2xl group-hover:bg-zuccini/10 transition-all duration-700"></div>

                <div className="flex items-center gap-3 mb-4">
                  <div className="bg-zinc-800 p-2 rounded-lg shadow-inner border border-zinc-700/40">
                    <svg className="w-4 h-4 text-zuccini" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
                        strokeWidth={2}
                ...
                <div className="space-y-3">
                  ...
                  <div key={index} className="flex items-center justify-between py-2.5 px-4 bg-zinc-800/80 hover:bg-zinc-800 rounded-lg shadow-sm border border-zinc-700/20 transition-colors duration-200">
                    <div className="flex items-center gap-3" >
                        <div className="w-2.5 h-2.5 bg-zuccini rounded-full"></div>
                        <span className="text-sm font-medium text-gray-200">{plan.name}</span>
                      </div>
                      <div className="text-right">
                        <span className="font-bold text-zuccini">
                ...
                <div className="mt-4 pt-3 border-t border-zinc-700/30">
                  <p className="text-xs text-zuccini text-center font-medium">
              ...
              <div className="mt-6 space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-zuccini to-blue-600 hover:from-blue-600 hover:to-zuccini 
                    text-white font-medium py-3.5 px-5 rounded-xl transition-all duration-300 block text-center
                    shadow-lg shadow-zuccini/20 hover:shadow-zuccini/30 border border-blue-500/30
