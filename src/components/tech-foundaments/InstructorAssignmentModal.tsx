          ...
          <div className="mb-6">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-secondary"
              />
              <button
        ...
        <div className="p-6 border-t border-zinc-700 flex justify-between items-center gap-4">
          ...
          <div className="flex gap-3 ml-auto">
            ...
            <button
              ...
              className="px-4 py-2 bg-secondary hover:bg-blue-600 text-white rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
            >
              {saving ? (
                <>
