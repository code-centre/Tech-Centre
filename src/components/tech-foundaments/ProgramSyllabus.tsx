  ...
  return (
    <section className="flex flex-col gap-2">
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-2xl font-bold text-secondary">Temario</h2>
      </div>
              ...
              {editingModuleIndex === i ? (
                <div className="w-full flex flex-col gap-2">
                  <input
                    ...
                    className="border border-gray-600 px-3 py-2 rounded-md w-full bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-secondary"
                  ...
                  {editingModuleIndex === i ? (
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="border border-gray-600 px-2 py-1 rounded-md flex-1 bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-secondary"
