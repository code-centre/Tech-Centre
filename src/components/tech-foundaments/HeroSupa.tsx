...
export function HeroSupa({ title, subtitle, date, heroImage, cohorte, video, user, saveChanges }: Props) {
  ...
  return (
    <>
      <section className="relative w-full min-h-[350px] lg:min-h-[420px] flex items-stretch overflow-hidden rounded-xl mb-8">
        ...
        />
        {/* {shortCourse?.id && user?.role === "admin" && (
          <FileUpload
            entityId={shortCourse.id}
        ...
        {/* Content */}
        <div className="relative flex flex-col justify-center h-full w-full lg:w-1/2 px-6 py-10 max-w-full">
