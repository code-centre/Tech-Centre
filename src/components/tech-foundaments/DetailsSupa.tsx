...
export default function DetailsSupa() {
    ...
    <div className="max-w-full bg-bgCard rounded-xl shadow-xl overflow-hidden transform transition-all duration-300 hover:shadow-2xl border border-zinc-800/30">
      ...
      <div className="p-4 text-white flex flex-col justify-between items-center">
        ...
        <ul className="list-disc marker:text-[#00A1F9] pl-8 flex flex-col gap-5 mt-2">
          ...
          <li className="flex items-start gap-2 text-white">
            <div className='bg-blueApp rounded-full w-3 h-3 flex-shrink-0 mt-2'></div>
            Conectarás con una comunidad activa de estudiantes, mentores y expertos del ecosistema tech. Además, tendrás acceso a eventos, talleres y espacios exclusivos organizados por Código Abierto.</li>
          <li className="flex items-start gap-2 text-white">
            <div className='bg-blueApp rounded-full w-3 h-3 flex-shrink-0 mt-2'></div>
