  ...
  return (
    <div className="bg-background backdrop-blur-sm">
      <main className="max-w-7xl mx-10 px-4 py-12">
        ...
        <section id="aprenderas" className="bg-bgCard backdrop-blur-sm rounded-2xl p-8 border border-blue-100/20 shadow-lg gap-12 mb-16">
          <Details
        ...
        <section id="programa" className="bg-bgCard backdrop-blur-sm rounded-2xl p-8 border border-blue-100/20 shadow-lg gap-12 mb-16">
          <Syllabus
        ...
        <div className="bg-bgCard backdrop-blur-sm p-8 rounded-2xl border border-blue-100/20 shadow-lg flex justify-center items-center w-full gap-12 mb-16" id="profesores">
          <ProfessorContainer
        ...
        <div id="precios" className="flex items-center justify-center gap-12 mb-16 ">
          <div className="bg-bgCard backdrop-blur-sm p-8 rounded-2xl border border-blue-100/20 shadow-lg w-full">
            <Tickets
          ...
          <section id="beneficios" className="bg-bgCard backdrop-blur-sm rounded-2xl p-8 border border-blue-100/20 shadow-lg gap-12 mb-16 ">
          <Benefits
        ...
        <section id="preguntas" className="bg-bgCard backdrop-blur-sm rounded-2xl p-8 border border-blue-100/20 shadow-lg gap-12 mb-16">
          <FAQs
            faqs={techs[0]?.faqs || []}
            eventId={eventId}
