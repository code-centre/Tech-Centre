      ...
      <section className="w-full">
        ...
        <div className="flex justify-between items-center mb-6">
          ...
          {isAdmin && instructor && (
            <button
              ...
              className="px-4 py-2 text-sm font-medium text-gray-300 bg-gray-800/50 border border-gray-700 rounded-md hover:bg-gray-800 hover:border-zuccini/50 transition-all duration-200 flex items-center gap-2"
        ...
        {loading ? (
          ...
          <div className="bg-linear-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl border border-zinc-700/50 overflow-hidden shadow-xl">
            {/* Profile Header */}
            <div className="relative bg-linear-to-r from-zuccini/20 via-zinc-800 to-zinc-800 px-6 pt-8 pb-20">
              <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
                ...
                <div className="relative">
                  ...
                  {isAdmin && (
                    <button
                      onClick={() => setIsModalOpen(true)}
                      className="absolute -bottom-2 -right-2 p-2 bg-zuccini hover:bg-blue-600 rounded-full shadow-lg transition-all duration-200 hover:scale-110"
                      aria-label="Editar profesor"
                    >
              ...
              {instructor.bio && (
                <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/30">
                  <div className="flex items-start gap-3">
                    <CodeIcon className="w-5 h-5 text-zuccini mt-0.5 shrink-0" />
          ...
          <div className="bg-zinc-900/50 rounded-xl border-2 border-dashed border-zinc-700/50 p-12">
            <div className="flex flex-col items-center justify-center text-center">
              ...
              {isAdmin && (
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="px-6 py-3 bg-zuccini hover:bg-blue-600 text-white font-medium rounded-lg transition-all duration-200 flex items-center gap-2 hover:shadow-lg hover:shadow-zuccini/20"
                >
