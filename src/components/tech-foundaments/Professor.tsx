          ...
          >
            ...
            <div className="relative group">
              ...
              <div className="absolute -bottom-12 left-1/2 transform -translate-x-1/2">
                <div className="w-60 h-60 rounded-full overflow-hidden border-2 border-zuccini shadow-lg shadow-black/30 group-hover:border-blue-400 transition-all">
                  <Image
                    width={200}
                    height={200}
            ...
            <div className="px-6 pt-16 pb-6 flex flex-col items-center">
              ...
              {speaker.bio && (
                <div className="bg-zinc-800/70 w-full rounded-lg p-4 mb-4 border border-zinc-700/20">
                  <div className="flex items-center gap-2 mb-2">
                    <Book className="text-zuccini h-4 w-4" />
              ...
              {speaker.linkedin && (
                <a
                  ...
                  className="flex items-center justify-center gap-2 mt-2 text-sm text-zuccini hover:text-blue-400 transition-colors"
                >
