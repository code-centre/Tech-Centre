	...
	const [formPerUser, setFormPerUser] = useState([
		{
			...
			...((titleEntity === 'Barranqui-IA' || slugProgram) && {
				isAllergic: 'No', foodRestriction: 'Ninguna', hasCar: 'NO',
				...(hasCar === 'SI' && { carPlate: '' }),
			}),
				...
				if (credentials && credentials.user) {
					...
					await setDoc(doc(db, "users", userWithCredentials.uid), {
						...
						...(titleEntity === 'Barranqui-IA' && {
							isAllergic: user.isAllergic, foodRestriction: user.foodRestriction, hasCar: user.hasCar,
	...
	return (
		<ModalPortal>
			<div className="fixed inset-0 flex items-center justify-center z-[100] p-4">
				<div className='absolute top-0 left-0 w-full h-full bg-black/50 poacity-2z-50 flex justify-center items-center place-content-center'>
