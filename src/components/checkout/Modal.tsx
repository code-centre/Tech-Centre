...
export default function Modal({
  ...
  const verifyEmailInFirebase = async () => {
    ...
    await Promise.all(
      formPerUser.map(async (user, index) => {
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 flex items-start justify-center z-[100] z-50 p-4 overflow-y-auto">
        <div className="absolute top-0 left-0 w-full h-full bg-black/50 opacity-50 z-50"></div>
        <div
          className={`bg-white relative flex flex-col ${typeUser ? "justify-between" : "justify-center items-center"} p-4 md:p-10 pt-5 rounded-md max-w-7xl w-full max-h-[90vh] mx-5 md:mx-10 my-4 md:my-20 z-[60] overflow-y-auto`}
        >
          <div className="flex items-center justify-between lg:mb-10">
            {typeUser && (
              <>
                ...
                />
                <span className="text-sm md:text-lg text-blueApp top-5 right-0 w-fit text-center left-0">
                  Formulario por persona: {userForm + 1} / {quantity}
                </span>
              </>
            )}
              ...
              {!typeUser && (
                <>
                  <h2 className="text-base md:text-xl font-bold text-center">
                    ¿Eres persona natural o vienes representando a una empresa?
                  </h2>
                  <div className="flex flex-col md:flex-row gap-2 justify-center my-5">
                    <button
                      onClick={() => setTypeUser("personal")}
                      className="bg-blueApp hover:bg-blueApp/80 py-2 px-5 text-white text-sm md:text-base font-semibold rounded-md"
                    >
                      Persona natural
                    </button>
                    <button
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center w-full items-center">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="name"
                        defaultValue=""
                        value={formPerUser[userForm].name}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                        placeholder="Nombres"
                      />
                    </label>
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="lastName"
                        defaultValue=""
                        value={formPerUser[userForm].lastName}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center w-full items-center">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="email"
                        defaultValue=""
                        value={formPerUser[userForm].email}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="email"
                    ...
                    {typeUser === "company" && (
                      <label className="flex flex-col gap-2 w-full">
                        ...
                        <input
                          ...
                          name="nit"
                          defaultValue=""
                          value={formPerUser[userForm].nit}
                          className="w-full text-sm border px-2 py-2 rounded-md"
                          type="text"
                          placeholder="NIT"
                        />
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center w-full">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="idNumber"
                        defaultValue=""
                        value={formPerUser[userForm].idNumber}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                        placeholder="Cédula"
                      />
                    ...
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        onChange={handleOnChangeInput}
                        name="age"
                        value={formPerUser[userForm].age}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                        placeholder="Edad"
                      />
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="phone"
                        defaultValue=""
                        value={formPerUser[userForm].phone}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                    ...
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="address"
                        defaultValue=""
                        value={formPerUser[userForm].address}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="occupation"
                        defaultValue=""
                        value={formPerUser[userForm].occupation}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                    ...
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        ...
                        name="company"
                        defaultValue=""
                        value={formPerUser[userForm].company}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                        placeholder="Empresa donde trabaja o estudia"
                      />
                    </label>
                  </div>
                </section>
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center w-full">
                      ...
                      <>
                        <label className="flex flex-col gap-2 w-full">
                          ...
                          <select
                            onChange={handleOnChangeInput}
                            name="size"
                            defaultValue={formPerUser[userForm].size}
                            value={formPerUser[userForm].size}
                            className="w-full text-sm border px-2 py-2 rounded-md"
                          >
                    ...
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        onChange={handleOnChangeInput}
                        name="bloodType"
                        defaultValue={formPerUser[userForm].bloodType}
                        value={formPerUser[userForm].bloodType}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                  ...
                  <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center">
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        onChange={handleOnChangeInput}
                        name="emergencyName"
                        defaultValue={formPerUser[userForm].emergencyName}
                        value={formPerUser[userForm].emergencyName}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="text"
                    ...
                    <label className="flex flex-col gap-2 w-full">
                      ...
                      <input
                        onChange={handleOnChangeInput}
                        name="emergencyPhone"
                        defaultValue={formPerUser[userForm].emergencyPhone}
                        value={formPerUser[userForm].emergencyPhone}
                        className="w-full text-sm border px-2 py-2 rounded-md"
                        type="number"
                  ...
                  {titleEntity === "Barranqui-IA" && (
                    <>
                      <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center">
                        ...
                        <label className="flex flex-col gap-2 w-full">
                          <span className="text-sm">¿Tienes alguna restricción alimenticia?</span>
                          <select
                            onChange={handleOnChangeInput}
                      ...
                      <div className="flex flex-col md:flex-row gap-5 lg:gap-2 justify-center items-center">
                        <label htmlFor="" className="flex flex-col gap-2 w-full">
                          <span className="text-sm">¿Llevas vehículo?</span>
                          <div className="flex justify-center gap-6 mt-2 text-gray-500">
                            <label className="flex items-center gap-2 text-sm">
                              SÍ
                              <input
                                onChange={(e) => {
                                  handleOnChangeInput(e), setHasCar("SI")
                                }}
                                name={`hasCar`}
                                type="radio"
                                value="SI"
                            ...
                            <label className="flex items-center gap-2 text-sm">
                              ...
                              <input
                                onChange={(e) => {
                                  handleOnChangeInput(e), setHasCar("NO")
                                }}
                                name={`hasCar`}
                                type="radio"
                                value="NO"
                        ...
                        {(hasCar === "SI" || formPerUser[userForm]?.hasCar === "SI") && (
                          <label htmlFor="" className="flex flex-col gap-2 w-full">
                            ...
                            <input
                              onChange={handleOnChangeInput}
                              name="carPlate"
                              value={formPerUser[userForm]?.carPlate}
                              type="text"
                              className="px-2 py-2 rounded-md text-black border text-sm"
                            />
                          </label>
          ...
          {typeUser && (
            <div className="flex flex-col gap-2 mt-10">
              {error && <p className="text-red-500 text-sm text-center">Todos los campos son requeridos</p>}
              <button
                onClick={handleAddNewForm}
                disabled={disableButton}
                className="bg-blueApp hover:bg-blueApp/80 py-2 text-white text-base font-semibold my-2 rounded-md"
              >
                {userForm === quantity - 1 ? "Ir a pagar" : "Continuar"}
              </button>
            </div>
          )}
          <p
            className={`text-xs  mt-10 ${!typeUser && "absolute bottom-5 left-0 right-0 "} text-gray-500 justify-center p-2 rounded-md flex items-center gap-2 animate-bounce`}
          >
            {" "}
            <Info className="inline w-10 h-10 md:w-4 md:h-4" />
            Al inscribirte {slugProgram ? "al diplomado" : "al evento"} aceptas términos y condiciones previstos por los
            organizadores
          </p>
        </div>
      </div>
