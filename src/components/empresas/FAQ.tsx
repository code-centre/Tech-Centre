      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl text-secondary font-bold mb-4">Preguntas frecuentes</h2>
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-bgCard rounded-xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 border border-zinc-800/30 group  sm:rounded-lg p-2">
                ...
                >
                  ...
                  {openIndex === index ? <ChevronUp className="h-5 w-5 text-secondary" /> : <ChevronDown className="h-5 w-5 text-secondary" />}
                </button>
                {openIndex === index && (
          ...
          <div className="mt-12 text-center">
            <p className="text-secondary mb-6">¿No encontraste lo que buscabas?</p>
              <button
                type="button"
