...
export default function SolicitarPasantia({ hayOfertas }: SolicitarPasantiaProps) {
  ...
  if (!hayOfertas) {
    ...
    <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl font-bold text-zuccini">Solicitar Pasantía</h1>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <input id="institucion" name="institucion" required value={formData.institucion} onChange={handleChange} className="mt-1 bg-white block w-full rounded-md border-zuccini shadow-sm focus:border-zuccini focus:ring-zuccini sm:text-sm p-2 border-2" type="text" />
            </div>
