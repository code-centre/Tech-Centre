      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white flex items-center gap-3">
            <div className="p-2 bg-zuccini/10 rounded-lg">
              <GraduationCap className="text-zuccini" size={28} />
            </div>
        ...
        {!isAdding && !editingId && (
          <button 
            ...
            className="px-6 py-3 bg-zuccini hover:bg-blue-600 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl hover:shadow-zuccini/20 hover:-translate-y-1 active:translate-y-0 flex items-center gap-2"
          >
            <Plus size={20} />
            Nuevo Programa
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl border border-zinc-700/50 p-6 shadow-lg">
          <div className="flex items-center justify-between">
            ...
            <div className="p-3 bg-zuccini/10 rounded-lg">
        ...
        <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl border border-zinc-700/50 p-6 shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-zuccini">{stats.withCohorts}</p>
            </div>
            <div className="p-3 bg-zuccini/10 rounded-lg">
              <Users className="text-zuccini" size={24} />
            </div>
          </div>
        </div>
      </div>
          ...
          {(['all', 'active', 'inactive'] as FilterType[]).map((filterType) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg font-medium transition-all duration-200 ${
                filter === filterType
                  ? 'bg-zuccini text-white shadow-lg'
          ...
          <form onSubmit={(e) => {
            ...
            handleSave();
              ...
              <label className="block text-sm font-medium text-gray-300 mb-2">Nombre *</label>
                ...
                className="w-full p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-zuccini"
              ...
              <label className="block text-sm font-medium text-gray-300 mb-2">Dificultad</label>
                ...
                className="w-full p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-zuccini"
                    >
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white font-mono text-sm focus:outline-none focus:ring-2 focus:ring-zuccini"
                rows={5}
            ...
            <div className="md:col-span-2 flex justify-end gap-3 mt-4">
              ...
              <button
                type="submit"
                className="px-6 py-3 bg-zuccini hover:bg-blue-600 text-white font-medium rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                disabled={saving}
              >
                {saving ? (
                  <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPrograms.length === 0 ? (
            ...
            filteredPrograms.map((program) => (
              <div
                key={program.id}
                className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl border border-zinc-700/50 overflow-hidden shadow-lg hover:shadow-xl hover:shadow-zuccini/20 transition-all duration-300 hover:-translate-y-1 flex flex-col"
              >
                {/* Imagen */}
                {program.image && (
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-gray-300">
                      <DollarSign className="w-4 h-4 text-zuccini" />
                  ...
                  <div className="mt-auto pt-4 border-t border-zinc-700/50 flex items-center gap-2">
                    <Link
                      ...
                      className="flex-1 px-4 py-2 bg-zuccini/10 hover:bg-zuccini/20 text-zuccini font-medium rounded-lg transition-all duration-200 text-center text-sm"
                    >
                      Ver Detalles
                    </Link>
                    <button
          ...
          <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] flex flex-col border border-zinc-700/50">
            ...
            <div className="bg-zinc-800/50 px-6 py-4 flex justify-end rounded-b-xl">
              <button
                type="button"
                onClick={closeSyllabusModal}
                className="px-6 py-2 bg-zuccini text-white rounded-lg hover:bg-blue-600 transition-all duration-200"
              >
                Cerrar
              </button>
            </div>
