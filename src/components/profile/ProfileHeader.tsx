    ...
    <div className="space-y-6 mb-8">
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between text-sm">
          <span className="text-text-primary font-medium">Perfil: {completionPercentage}% completo</span>
          <span className="text-text-muted">{completionPercentage}/100</span>
        </div>
        <div className="w-full h-2.5 bg-bg-secondary rounded-full overflow-hidden border border-border-color">
          <div
      ...
      <div className="flex flex-wrap gap-3">
        {benefits.map((benefit, index) => {
          ...
          return (
            <div
              key={index}
              className="flex items-center gap-2 px-3 py-1.5 bg-bg-secondary border border-border-color rounded-md text-xs text-text-primary"
            >
