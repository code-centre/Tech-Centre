      ...
      <div className='flex flex-col items-center gap-8'>
        ...
        {showForm && (
            <form onSubmit={handleSubmit} className="w-full max-w-md space-y-4">
                ...
                <label className="block text-sm font-medium text-secondary">Nombre de la evaluación*</label>
                <input
                    type="text"
                    name="name"
                ...
                <div className="space-y-2">
                    <label className="block text-sm font-medium text-secondary">Valor máximo*</label>
                    <input
                    type="number"
                    name="max_value"
                ...
                <div className="space-y-2 bg-white">
                    <label className="block text-sm font-medium text-secondary">Peso (opcional)</label>
                    <input
                    type="number"
                    name="weight"
                ...
                <div className="space-y-2 bg-white p-4 rounded-xl">
                <label className="block text-sm font-medium text-secondary">Fecha de entrega*</label>
                <input
                    type="datetime-local"
                    name="due_at"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2 bg-white p-4 rounded-xl">
                    <label className="block text-sm font-medium text-secondary">Módulo ID</label>
                    <input
                      type="number"
                      name="module_id"
                  ...
                  <div className="space-y-2 bg-white p-4 rounded-xl">
                    <label className="block text-sm font-medium text-secondary">Cohorte ID</label>
                    <input
                      type="number"
                      name="cohort_id"
                ...
                <div className="space-y-2 bg-white p-4 rounded-xl">
                <label className="block text-sm font-medium text-secondary">Archivo adjunto (opcional)</label>
                <input
                    type="file"
