        ...
        {sections.map((section) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-3 py-2 rounded-md text-sm font-medium mb-1 ${activeSection === section.id ? 'bg-blue-50 text-zuccini' : 'text-gray-600 hover:bg-gray-50'}`}
            >
              <Icon size={20} />
              {section.label}
            </button>
