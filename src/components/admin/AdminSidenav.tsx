...
import { GraduationCap, Users, FileText, UserCog, Shield, Newspaper, CalendarDays, BrainCircuit, Mail, BarChart3 } from 'lucide-react';
...
const allNavItems = [
  ...
  { href: '/admin/marketing', label: 'Marketing', icon: BarChart3, adminOnly: true },
  ...
  { href: '/admin/instructores', label: 'Profesores', icon: UserCog, adminOnly: true },
          ...
          return (
            <Link
              ...
              className={`
                ...
                ${
                  isActive
                    ? 'bg-secondary/20 text-text-secondary border border-secondary/30'
            ...
            >
              ...
              <Icon
                size={20}
                className={isActive ? 'text-text-secondary' : 'text-text-muted group-hover:text-text-secondary'}
              />
