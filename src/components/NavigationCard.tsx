      ...
      <div className="px-6 pb-1 relative z-10">
        <div className="text-center">
          ...
          <button
            ...
            className="w-full cursor-pointer bg-white text-zuccini py-4 px-6 my-4 rounded-xl font-semibold hover:bg-blue-50 transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 flex items-center justify-center space-x-2">
