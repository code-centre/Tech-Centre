    ...
    return (
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="w-8 h-8 border-4 border-zuccini border-t-transparent rounded-full animate-spin mx-auto"></div>
        </div>
      </section>
    );
  }
    ...
    <section className="py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-zuccini">Lo que dicen nuestros estudiantes</h2>
            ...
            {[...reviews, ...reviews].map((review, index) => (
              ...
              >
                <div className="flex items-center justify-center mb-4">
                  <div className="text-4xl font-bold text-zuccini">&ldquo;</div>
                </div>
                ...
                <div className="flex items-center justify-center gap-3 mt-6">
                  ...
                  />
                  <div>
                    <h4 className="font-medium text-zuccini">{review.author_name}</h4>
        ...
        <div className="text-center mt-10">
          <a
            ...
            className="text-zuccini hover:underline font-medium inline-flex items-center gap-2"
          >
