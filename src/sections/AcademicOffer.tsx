...
function ProgramCardOptimized({ program }: ProgramCardProps) {
        ...
        <div className="mb-4">
          <div className="flex items-center gap-2 justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-emerald-600 dark:text-emerald-400">Inicio: Febrero 2026</span>
            </div>
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {programs.map((program) => (
              <ProgramCardOptimized key={program.id} program={program} />
            ))}
          </div>
        ) : (
          <div className="text-center py-12 bg-bg-card rounded-xl border border-border-color">
